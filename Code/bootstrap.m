function [frame1, S0, S1, Twc1] = bootstrap(ds, path, left_images, frame0, max_frame, K)
max_num_matches = 0;
...
for frame = frame0 + 1 : max_frame
    ...
    [S0_curr, S1_curr, Twc1_curr] = ransacTriangulationDistRatio(img0, img1, K);
