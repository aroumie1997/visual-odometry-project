function [frame1, image1, S0, S1, Twc1] = bootstrapKLT_truthScale(...
    ds, path, left_images, frame0, max_frame, K, ground_truth)
...
for frame = frame0 + 1 : frame0 + max_frame
    ...
    % Triangulate
    [S0_curr, S1_curr, Twc1_curr] = ransacTriangulationDistRatioKLT_truthScale(...
        img0_keypoints, img1_keypoints, Twc0, K,...
        ground_truth(frame0,:), ground_truth(frame,:));
