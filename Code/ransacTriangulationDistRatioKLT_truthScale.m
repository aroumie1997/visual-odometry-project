function [prev_S, S, Twc] = ransacTriangulationDistRatioKLT_truthScale(...
    database_keypoints, query_keypoints, database_Twc, K,...
    database_truth, query_truth)
...
% Scale transformation to true scale
t_C1_C0 = t_C1_C0 / norm(t_C1_C0) * norm(database_truth - query_truth);
